// --- Słowniki (lookup tables, read-only po stronie klienta) ---
...
// --- Osoby (opiekunowie, skauci, trenerzy) ---
...
// --- Zawodnik (encja nadrzędna, 1 → N obserwacji) ---
...
export interface Observation {
  ...
  potentialNow?: number | null; // 1-5
  potentialFuture?: number | null; // 1-5
  comment?: string | null;
  notes?: string | null;
  scoutId?: string | null;
...
// --- Decyzje / statusy (historia, brak nadpisywania) ---
